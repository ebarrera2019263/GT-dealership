# Graph Report - concesionario  (2026-07-14)

## Corpus Check
- 212 files · ~75,153 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1611 nodes · 2944 edges · 162 communities (83 shown, 79 thin omitted)
...
2. `useT()` - 79 edges
3. `UsuarioActual` - 74 edges
4. `useAuth()` - 63 edges
5. `PrismaService` - 52 edges
6. `VehiculosService` - 33 edges
7. `cn()` - 32 edges
8. `AdminCatalogoService` - 30 edges
9. `ZodValidationPipe` - 25 edges
10. `AdminCatalogoController` - 23 edges

## Surprising Connections (you probably didn't know these)
- `generateMetadata()` --calls--> `getI18n()`  [EXTRACTED]
  apps/web/app/layout.tsx → apps/web/lib/i18n/server.ts
...
- `AdminAuditoriaPage()` --calls--> `useT()`  [EXTRACTED]
  apps/web/app/admin/auditoria/page.tsx → apps/web/lib/i18n/provider.tsx
...
## Communities (162 total, 79 thin omitted)
...
Cohesion: 0.13
Nodes (15): dependencies, @base-ui/react, clsx, next, react-dom, shadcn, tailwind-merge, tw-animate-css (+7 more)
...
Cohesion: 0.14
Nodes (17): EntrarPage(), FormularioEntrar(), RegistroPage(), BotonReporte(), Estado, MOTIVOS, Estado, FormularioLead() (+9 more)
...
Cohesion: 0.12
Nodes (13): UsuarioAutenticado, Get, CitasController, Body, Controller, Get, HttpCode, Param (+5 more)

### Community 11 - "Cliente API / listados (web)"
Cohesion: 0.12
Nodes (23): FILTROS_VALIDOS, generateMetadata(), ListadoPage(), FichaPage(), generateMetadata(), LegalPage(), Home(), Filtros() (+15 more)

### Community 12 - "shadcn/ui (componentes)"
Cohesion: 0.07
Nodes (31): LanguageSwitcher(), Enlace, EnlaceNav(), esActivo(), Navbar(), PUEDE_VENDER, Button(), buttonVariants (+23 more)

### Community 13 - "Búsquedas guardadas"
Cohesion: 0.10
Nodes (14): BusquedasController, Body, Controller, Delete, HttpCode, Param, Patch, Post (+6 more)
...
Cohesion: 0.11
Nodes (25): ModeracionPage(), Pendiente, AdminSolicitudesPage(), ESTADOS, Solicitud, AdminVehiculosPage(), ESTADO_CLASE, ESTADOS (+17 more)

### Community 21 - "Mensajería"
Cohesion: 0.11
Nodes (12): MensajeriaController, Body, Controller, Get, Param, Post, MensajeriaService, PARTICIPANTE (+4 more)
...
Cohesion: 0.08
Nodes (27): AppModule, Module, Env, envSchema, bootstrap(), AuthModule, Module, PerfilPublico (+19 more)
...
Cohesion: 0.07
Nodes (37): AdminCatalogoPage(), Marca, Modelo, AdminLayout(), NAV, AdminLeadsPage(), fecha(), Lead (+29 more)
...
Cohesion: 0.40
Nodes (5): ACCIONES, EDITABLE, ESTADO_CLASE, PanelPage(), VehiculoPanel
...
### Community 81 - ".lista"
Cohesion: 0.18
Nodes (17): BusquedaGuardada, BusquedasPage(), describir(), urlResultados(), LABELS, isLocale(), Locale, locales (+9 more)
...
Cohesion: 0.38
Nodes (6): anuncio(), BADGE, Cita, CitasPage(), fmtFecha(), VehiculoRef
...
Cohesion: 0.21
Nodes (9): fraunces, generateMetadata(), inter, RootLayout(), BotonFavorito(), Contexto, FavoritosContexto, FavoritosProvider() (+1 more)
...
## Knowledge Gaps
- **551 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `tsConfigPath` (+546 more)
...
- **Why does `UsuarioAutenticado` connect `Citas y notificaciones` to `Admin catálogo`, `Moderación de vehículos`, `Panel vendedor (transiciones)`, `Admin financiamiento`, `Favoritos y citas`, `UsuariosService`, `notificaciones.module.ts`, `vehiculos.service.ts`, `Búsquedas guardadas`, `Validación Zod (API)`, `Reportes`, `Solicitudes de crédito`, `Mensajería`, `.moderar`, `Imágenes (uploads)`, `page.tsx`, `RolesGuard`?**
