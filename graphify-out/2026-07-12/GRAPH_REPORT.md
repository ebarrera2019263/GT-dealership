# Graph Report - concesionario  (2026-07-12)

## Corpus Check
- 190 files · ~66,854 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1566 nodes · 2708 edges · 160 communities (86 shown, 74 thin omitted)
...
- `AdminCatalogoPage()` --calls--> `useAuth()`  [EXTRACTED]
  apps/web/app/admin/catalogo/page.tsx → apps/web/lib/auth.tsx
...
Cohesion: 0.10
Nodes (21): dependencies, argon2, dotenv, multer, @nestjs/common, @nestjs/platform-express, @nestjs/throttler, nodemailer (+13 more)
...
Cohesion: 0.20
Nodes (5): SolicitudesController, Body, Controller, Get, Post
...
Cohesion: 0.09
Nodes (27): fraunces, inter, metadata, RootLayout(), Enlace, EnlaceNav(), esActivo(), Navbar() (+19 more)
...
Cohesion: 0.14
Nodes (9): AdminSolicitudesController, Body, Controller, Get, Ip, Param, Patch, Query (+1 more)

### Community 20 - "Simulador de financiamiento"
Cohesion: 0.10
Nodes (25): ModeracionPage(), Pendiente, AdminSolicitudesPage(), ESTADOS, Solicitud, AdminVehiculosPage(), ESTADO_UI, ESTADOS (+17 more)

### Community 21 - "Mensajería"
Cohesion: 0.12
Nodes (12): MensajeriaController, Body, Controller, Get, Param, Post, MensajeriaModule, Module (+4 more)

### Community 22 - "Imágenes (uploads)"
Cohesion: 0.10
Nodes (15): ImagenesController, Body, Controller, Delete, HttpCode, Param, Post, Put (+7 more)
...
Cohesion: 0.17
Nodes (8): AuditoriaService, RegistroAuditoria, Injectable, SolicitudesService, Injectable, PERFIL_SELECT, PrismaService, Injectable
...
Cohesion: 0.08
Nodes (26): AppModule, Module, Env, envSchema, bootstrap(), AuthModule, Module, PerfilPublico (+18 more)
...
Cohesion: 0.15
Nodes (14): Conversacion, ConversacionPage(), hora(), Mensaje, ConversacionResumen, cuando(), MensajesPage(), AuthContexto (+6 more)
...
Cohesion: 0.11
Nodes (21): AdminLayout(), NAV, AdminReportesPage(), MOTIVO_LABEL, Reporte, AdminUsuariosPage(), Fila, ROLES (+13 more)
...
### Community 37 - "Leads"
Cohesion: 0.20
Nodes (10): AdminLeadsController, Controller, Roles, LeadsController, Controller, Publico, LeadsModule, Module (+2 more)
...
Cohesion: 0.33
Nodes (7): ActorTransicion, buscarTransicion(), ESTADOS_EDITABLES, Transicion, TRANSICIONES, DATOS_PRIVADOS, MAPA_TRACCION

### Community 43 - "notificaciones.module.ts"
Cohesion: 0.19
Nodes (8): CitasModule, Module, VEHICULO_SELECT, NotificacionesModule, Module, NotificacionesProcessor, EmailJob, Processor

### Community 44 - "page.tsx"
Cohesion: 0.10
Nodes (20): Acciones recomendadas (orden de ataque), Arreglos aplicados — 2026-07-12 (los dos P1), Arreglos aplicados — 2026-07-12 (los dos P3), Arreglos aplicados — 2026-07-12 (los tres P2), Auditoría técnica — Storefront (home · /autos · ficha), Cómo retomar, Estado de arreglos (ir tachando), Estado final (+12 more)
...
Cohesion: 0.33
Nodes (5): AdminCatalogoPage(), Marca, Modelo, Item, LookupCatalogo()
...
### Community 58 - "Body"
Cohesion: 0.14
Nodes (14): FichaPage(), generateMetadata(), Props, AgendarVisita(), BotonReporte(), Estado, MOTIVOS, ContactarVendedor() (+6 more)
...
Cohesion: 0.29
Nodes (5): AdminFinanciamientoPage(), APLICA_A, Entidad, FORM_VACIO, Plan
...
### Community 79 - "NotificacionesService"
Cohesion: 0.19
...
### Community 155 - "boton-favorito.tsx"
Cohesion: 0.38
...
Cohesion: 0.67
Nodes (3): AdminLeadsPage(), fecha(), Lead

## Knowledge Gaps
- **548 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `tsConfigPath` (+543 more)
...
- **Why does `UsuarioAutenticado` connect `Favoritos y citas` to `Admin catálogo`, `Moderación de vehículos`, `Admin financiamiento`, `Auth y páginas (web)`, `Citas y notificaciones`, `Búsquedas guardadas`, `Validación Zod (API)`, `Reportes`, `Solicitudes de crédito`, `Mensajería`, `.moderar`, `AdminVehiculosController`, `Imágenes (uploads)`, `.obtener`, `Panel vendedor (transiciones)`, `UsuariosService`, `vehiculos.service.ts`, `notificaciones.module.ts`, `page.tsx`?**
